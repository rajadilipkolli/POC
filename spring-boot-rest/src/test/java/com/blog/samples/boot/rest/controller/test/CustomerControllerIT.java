...
public class CustomerControllerIT
{
    ...
    {
        ResponseEntity<String> response = template.getForEntity("/rest/customers",
                String.class);
    ...
    public void updateCustomer() throws Exception
    {
        ...
        Long customerId = getCustomerIdByFirstName("Raja");
        ResponseEntity<String> getCustomerResponse = template
                .getForEntity(String.format("%s/%s", base, customerId), String.class);
        ...
        Customer customerToUpdate = mapper.readValue(getCustomerResponse.getBody(),
                Customer.class);
        ...
        ResponseEntity<String> getUpdatedCustomerResponse = template
                .getForEntity(String.format("%s/%s", base, customerId), String.class);
        assertThat(getCustomerResponse.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(getCustomerResponse.getHeaders().getContentType().toString())
                .isEqualTo(JSON_CONTENT_TYPE);

        Customer updatedCustomer = convertJsonToCustomer(
    ...
    public void deleteCustomer() throws Exception
    {
        ...
        ResponseEntity<String> secondCallResponse = template
                .getForEntity(String.format("%s/%s", base, customerId), String.class);
    ...
    public void getNonExistantCustomerReturnsError404() throws Exception
    {
        ...
        ResponseEntity<String> response = template
                .getForEntity(String.format("%s/%s", base, 999999), String.class);
