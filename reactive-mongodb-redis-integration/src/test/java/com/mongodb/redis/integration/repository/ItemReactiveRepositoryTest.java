...
class ItemReactiveRepositoryTest {
  ...
  void test01_getAllItems() {
    ...
    StepVerifier.create(allItems.log()).expectSubscription().expectNextCount(4).verifyComplete();
  }
  ...
  void test03_findItemByDescription() {
    StepVerifier.create(
            itemReactiveRepository.findByDescription("Bose Headphone").log("findByDescription"))
        .expectSubscription()
        .expectNextCount(1)
        .verifyComplete();
  }
