...
public class TwoNumberSumProblem {
	...
	public static void main(String[] args) {
		...
		System.out.println("TimeComplexity O(nlogn) output numbers " + Arrays.toString(values) + " ,timeTaken "
				+ (endTime - startTime));

		startTime = System.nanoTime();
		values = findSumByHashMap(inputArray, target);
		endTime = System.nanoTime();
		System.out.println("TimeComplexity O(n) output numbers " + Arrays.toString(values) + " ,timeTaken "
				+ (endTime - startTime));
