...
public class MultiplyTwoBigString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Multiply Optimized Way -> " + multiplyOptimized(a, b) + ", TimeTaken -> "
				+ (System.nanoTime() - startTime));
		startTime = System.nanoTime();
		System.out.println("Multiply MostOptimized Way -> " + multiplyMostOptimized(a, b) + ", TimeTaken -> "
				+ (System.nanoTime() - startTime));
